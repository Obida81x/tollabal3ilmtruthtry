...
const en: Dict = {
  ...
  "apply.button": "Apply to be an Admin",
  "apply.title": "Admin Application",
  "apply.description": "Fill out this form to apply for an administrator role.",
  "apply.fieldFullName": "Full name",
  "apply.fieldAge": "Age",
  "apply.fieldEmail": "Contact email",
  "apply.fieldReasons": "Why are you qualified?",
  "apply.fieldNotes": "Additional notes (optional)",
  "apply.submit": "Submit Application",
  "apply.submitting": "Submitting…",
  "apply.success": "Your application has been submitted. The main administrator will review it.",
  "apply.alreadyPending": "You already have a pending application.",

  "admin.tabs.applications": "Applications",
  "admin.tabs.settings": "Settings",
  "admin.applications.empty": "No applications yet.",
  ...
  "admin.applications.messagePlaceholder": "Optional message to applicant…",
  "admin.applications.reviewing": "Reviewing…",
  "admin.settings.supportEmail": "Support Email",
  "admin.settings.supportEmailDesc": "Users with login problems will contact this address.",
  ...
  "security.step1Password": "We will send a 6-digit code to your registered email address.",
  "security.step2Password": "Enter the code and choose a new password.",
  "security.step1Email": "Enter your new email address. We will send a verification code to your current email.",
  "security.step2Email": "Enter the code sent to your old email to confirm the change.",
  "security.sendCode": "Send Code",
  "security.sendingCode": "Sending…",
  "security.codeSent": "Code sent! Check your inbox.",
  ...
  "security.emailChanged": "Email updated successfully.",
  "security.passwordMismatch": "Passwords do not match.",
  "security.settings": "Security Settings",

  "login.loginProblems": "Login problems?",

  "support.title": "Contact Support",
  "support.subtitle": "Having trouble accessing your account? Describe your issue and we'll help.",
  "support.fieldUsername": "Your username",
  "support.fieldEmail": "Your email address",
  "support.fieldSubject": "Subject",
  "support.fieldMessage": "Describe your issue",
  "support.submit": "Send Message",
  "support.submitting": "Sending…",
  "support.success": "Your message has been sent. The administrator will contact you.",
  "support.backToLogin": "Back to login",
  "support.subjectOptions.login": "Cannot log in",
  "support.subjectOptions.email": "Lost access to my email",
  "support.subjectOptions.account": "Account issue",
  "support.subjectOptions.other": "Other",
...
const ar: Dict = {
  ...
  "apply.button": "التقدم لدور المشرف",
  "apply.title": "طلب الانضمام إلى فريق الإدارة",
  "apply.description": "أكمل هذا النموذج للتقدم لدور المشرف في المنتدى.",
  "apply.fieldFullName": "الاسم الكامل",
  "apply.fieldAge": "العمر",
  "apply.fieldEmail": "البريد الإلكتروني للتواصل",
  "apply.fieldReasons": "لماذا أنت مؤهل للدور؟",
  "apply.fieldNotes": "ملاحظات إضافية (اختياري)",
  "apply.submit": "إرسال الطلب",
  "apply.submitting": "جارٍ الإرسال…",
  "apply.success": "تم إرسال طلبك. سيقوم المسؤول الرئيسي بمراجعته.",
  "apply.alreadyPending": "لديك طلب معلق بالفعل.",

  "admin.tabs.applications": "الطلبات",
  "admin.tabs.settings": "الإعدادات",
  "admin.applications.empty": "لا توجد طلبات بعد.",
  "admin.applications.status.pending": "قيد المراجعة",
  "admin.applications.status.approved": "مقبول",
  "admin.applications.status.rejected": "مرفوض",
  "admin.applications.approve": "قبول",
  "admin.applications.reject": "رفض",
  "admin.applications.messagePlaceholder": "رسالة اختيارية للمتقدم…",
  "admin.applications.reviewing": "جارٍ المراجعة…",
  "admin.settings.supportEmail": "بريد الدعم الفني",
  "admin.settings.supportEmailDesc": "يتواصل المستخدمون الذين يواجهون مشكلات مع هذا البريد.",
  ...
  "security.changeEmail": "تغيير البريد الإلكتروني",
  "security.step1Password": "سنرسل رمز مكوّن من 6 أرقام إلى بريدك الإلكتروني المسجّل.",
  "security.step2Password": "أدخل الرمز واختر كلمة مرور جديدة.",
  "security.step1Email": "أدخل بريدك الإلكتروني الجديد. سنرسل رمز تحقق إلى بريدك الحالي.",
  "security.step2Email": "أدخل الرمز المرسل إلى بريدك القديم لتأكيد التغيير.",
  "security.sendCode": "إرسال الرمز",
  "security.sendingCode": "جارٍ الإرسال…",
  "security.codeSent": "تم إرسال الرمز! تحقق من بريدك الوارد.",
  "security.newPassword": "كلمة المرور الجديدة",
  "security.confirmPassword": "تأكيد كلمة المرور",
  "security.code": "رمز التحقق",
  "security.newEmail": "عنوان البريد الإلكتروني الجديد",
  "security.passwordChanged": "تم تغيير كلمة المرور بنجاح.",
  "security.emailChanged": "تم تحديث البريد الإلكتروني بنجاح.",
  "security.passwordMismatch": "كلمتا المرور غير متطابقتين.",
  "security.settings": "إعدادات الأمان",

  "login.loginProblems": "مشكلة في تسجيل الدخول؟",

  "support.title": "تواصل مع الدعم",
  "support.subtitle": "هل تواجه صعوبة في الوصول إلى حسابك؟ اشرح مشكلتك وسنساعدك.",
  "support.fieldUsername": "اسم المستخدم",
  "support.fieldEmail": "بريدك الإلكتروني",
  "support.fieldSubject": "الموضوع",
  "support.fieldMessage": "اشرح مشكلتك",
  "support.submit": "إرسال",
  "support.submitting": "جارٍ الإرسال…",
  "support.success": "تم إرسال رسالتك. سيتواصل معك المسؤول قريبًا.",
  "support.backToLogin": "العودة إلى تسجيل الدخول",
  "support.subjectOptions.login": "لا أستطيع تسجيل الدخول",
  "support.subjectOptions.email": "فقدت الوصول إلى بريدي الإلكتروني",
  "support.subjectOptions.account": "مشكلة في الحساب",
  "support.subjectOptions.other": "أخرى",
